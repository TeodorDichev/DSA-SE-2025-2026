# Семинар №6 - Дървета, Двоични наредени дървета (BST), Самобаланисращи се дървета (AVL, Red-Black)
...
### Балансирано BST
Балансирано BST наричаме BST дърво, за което е дефиниран инвариант, който гарантира, че височината на дървото е асимптотично равна на log(n).

**Balance Factor** - число, което оценява колко "балансиран" е всеки от върховете (дава оценка по зададен критерий). Чрез него можем лесно да дефинираме инварианта за балансиране на дървото.

Пресмятайки **balance factor** за всеки един връх, можем да дадем оценка колко близко до желано състояние (наречено балансирано състояние) е дадено дърво. В балансирано дърво операциите са с логаритмична сложност в най-лошият случай.
...
[05. Delete Tree](./Solutions/DeleteTree/main.cpp) - ЛДК (ляво-дясно-корен) обхождане

[06. Tree Indexator](./Solutions/TreeIndexator/main.cpp)

(**ЕXTRA**) - Към `Set.hpp` файла в имплементациите е добавена идея за **еднопосочен итератор на BST**, който се реализира чрез използване на stack.

[07. Top View](https://www.hackerrank.com/contests/sda-test3-2022-2023-rdsafgtvh/challenges/challenge-3757) - extra data в node-а

[08. Родословно дърво](https://www.hackerrank.com/contests/sda-hw-6-2022/challenges/parent) - ЛДК обхожане + extra data в node-а

[9. Царство](https://www.hackerrank.com/contests/kontrolno-3/challenges/challenge-4346) - extra data в node-а + използване на масив от node-ове за да имаме директен достъп до възлите

[EXTRA - Час по рисуване](https://www.hackerrank.com/contests/sda-hw-6-2023/challenges/task3score/problem) - **Hard**


## Задачи за std::set/std::map/std::multiset (Ще се разгледат допълнително в следващата тема също)

**Extra notes:** Прегледайте внимателно какви функции имат тези класове в STL и какво връщат те. Обърнете внимание на разликата във функциите като insert и contains за всеки от класовете! Полезно е да се знае, че с резултата от insert може да проверим дали и къде е вмъкнат елемент.

[10. Longest Substring Without Repeating Elements](https://leetcode.com/problems/longest-substring-without-repeating-characters) - По-добро решение би било с hash map. Другия път ще сравним

[11. Волейболни другарчета](https://www.hackerrank.com/contests/sda-hw-8/challenges/volleyball-friends) - Отново по-добро решение би било с hash map

* Аналогично - [Маската на зоро](https://www.hackerrank.com/contests/sda-hw-7-2022/challenges/zoros-mask)

[12. 2D Battleships](https://www.hackerrank.com/contests/sda-hw-7-2022/challenges/challenge-2590) - Тук наредбата е от значение и трябва да се ползва set (не става с hash set).
