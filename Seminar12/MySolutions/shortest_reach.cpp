...
vector<int> shortestReach(int n, vector<vector<int>> edges, int s) {
    // undirected graph
    // no negative edges but nothing said about cycles
    // so in conclusion dijkstra will be used
    s--;
    ...
    // dijkstra algorithm modified to not include start
    ...
    while (!nextToProcess.empty()) {
        auto curr = nextToProcess.top(); nextToProcess.pop();
        if (curr.distance > distances[curr.index]) continue;
